...
class View {
  ...
  createPage() {
    ...
    const questionPrompts = [
        ...
        " move the box up 20 pixles and to the right by 50 pixles",
    ...
    const correctCssCode = [
        ...
        ["transform: translate(25px,-50px)", "transform: translate(25px,-50px);", "transform:translate(25px,-50px)", "transform:translate(25px,-50px);"],
        ["transform: scale(1.5,1.5)", "transform: scale(1.5,1.5);", "transform:scale(1.5,1.5)", "transform:scale(1.5,1.5);"],
        ["transform: rotate(180deg)", "transform: rotate(180deg);", "transform:rotate(180deg)", "transform:rotate(180deg);"],
        ["transform: skew(10deg,10deg)", "transform: skew(10deg,10deg);", "transform:skew(10deg,10deg)", "transform:skew(10deg,10deg);"]
    ];
    const hints = [
      "translate",
      "translate",
  ...
  parentSection() {
    ...
    $section.append($prompt.text("CSS transitions let you decide which properties to animate (by listing them explicitly), when the animation will start (by setting a delay), how long the transition will last (by setting a duration), and how the transition will run. Each of the below CSS transitions/animations share a single CSS property. Please enter that property below:"));
    $section.append("<br/>");
